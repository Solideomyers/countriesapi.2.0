  ...
  return (
    <>
      <p className="text-gray-500 text-xl leading-[2.5rem]">
        ...
        corresponding classes. It is at this level that the "chicks" walk on
        their own. It serves not only to affirm previously learned knowledge but
        also prepares us for the final stage of the BOOTCAMP, PF.
      </p>
    </>
  )
}
