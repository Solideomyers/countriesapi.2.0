...
export const Filters = () => {
  ...
  // console.log(populationsRef.current)
  ...
  const handleFilterChange = useCallback(
    (name, value) => {
      // references update
      // console.log(value)
      // countriesRef.current.value = value
      // populationsRef.current.value = value
      // orderazRef.current.value = value
      // activitiesRef.current.value = value
